...
const Cart = () => {
  ...
  const payment = async (token) => {
    await axios.post('https://server-store.onrender.com/pay', {
      amount: totalAmt * 100,
      token: token
    })
  }
          ...
          <div className="w-1/3 bg-[#fafafa] py-6 px-4">
            ...
            {payNow && (
              <div className="w-full mt-6 flex items-center justify-center">
                <StripeCheckout
                  stripeKey="pk_test_51MYvhVJdzcHxDUvhKYlWrpRSB4Cqva3VbmnuFWISTtVPa7B30px2sFb9t6QH2LVurHsW8WkKJNwYfFbWn29MBvhL00ZGHd9iwn"
